...
class HomeController extends Controller
{
    public function index(){
       ...
       if(Navigation::query()->where('nav_category','Home')->where('nav_name', 'LIKE', "%about%")->where('page_type','Group')->latest()->first()!=null){
        ...
        //return $missons;       
        return view("website.index")->with([  'videos'=>$videos,'gallery'=>$gallery,'eventsection'=>$eventsection,'team'=>$team,'newsevents'=>$newsevents,'detailspage'=>$detailspage,'projectlist'=>$projectlist,   'testimonial'=>$testimonial,'statistics'=>$statistics,'partners'=>$partners,'about'=>$About,'menus'=>$menus,'global_setting'=>$global_setting,'sliders'=>$sliders,'missons'=>$missons,'message'=>$message,'jobs'=>$jobs]);
    }
...
//nabinteam
    ...
    //    return  $detailspage;
        ...
        elseif ($subcategory_type == "Team") {
            ...
            // return "hlo";
            return view("website.team")->with(['team'=>$team,"partners" => $partners, 'team_heading' => $team_heading, 'team' => $team, 'jobs' => $jobs, 'menus' => $menus, 'sliders' => $sliders, 'about' => $About, 'global_setting' => $global_setting, 'slug_detail' => $slug_detail, 'teamsub' => $teamsub]);
        }
